...
sequences = [
    {
        'sequence': ['aleff', 'nun', 'aleff', 'aleff', 'ain', 'taa', 'yaa', 'nun', 'aleff', 'kaaf', 'al', 'kaaf', 'waw', 'thaa', 'ra'],
        'phrase': 'إِنَّآ أَعۡطَيۡنَٰكَ ٱلۡكَوۡثَرَ',
        'order': 0,
        'index': 0,
        'completed': False
    },
    {
        ...
        'phrase': 'فَصَلِّ لِرَبِّكَ وَٱنۡحَرۡ',
        'order': 1,
        'index': 0,
        'completed': False
    },
    {
        'sequence': ['aleff', 'nun', 'sheen', 'aleff', 'nun', 'aleff', 'kaaf', 'ha', 'waw', 'al', 'aleff', 'bb', 'ta', 'ra'],
        'phrase': 'إِنَّ شَانِئَكَ هُوَ ٱلۡأَبۡتَرُ',
        'order': 2,
        'index': 0,
        'completed': False
    },
...
def video_feed_al_kawthar(request):
    """Stream video feed to the browser."""
    return StreamingHttpResponse(webcam_feed_al_kawthar(),
                                 content_type='multipart/x-mixed-replace; boundary=frame')

# API endpoint to check sequence statuses
def check_sequence_status_al_kawthar(request):
...
def reset_sequences_al_kawthar(request):
    global current_order
...
def get_current_sequence_status_al_kawthar(request):
...
def surat_al_kawthar(request):
    return render(request, 'recognition/surat_al_kawthar.html')
